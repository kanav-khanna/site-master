<?php
  ...
  $msg = '
  <body>
    <div style="border:none; border-bottom: 2px solid #ffffff; background-color: #f60000; color:#f1f1f1; padding-bottom:5px; padding-top:5px; text-align:center">
      <strong>Congratulations! Your subscription is confirmed</strong>
      <p>you will receive email regarding our new post and services. Thank You.</p>
    </div>
