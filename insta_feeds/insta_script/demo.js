...
$(document).ready(function() {
    ...
    let playgroundOptions = {
        ...
        limit: 10,
        link: true,
        template: '<div class="post"><a href="{{link}}"><img src="{{image}}" alt="{{accessibility_caption}} " target="_blank"><span class="meta"><p>{{caption}}</p><span class="stats"><span class="likes"><i class="fas fa-heart"></i>{{likes}}</span><span class="comments"><i class="fas fa-comment"></i>{{comments}}</span></span></a></div>'
    };
    ...
    let rawData = $.instastory('@darksqrca');
