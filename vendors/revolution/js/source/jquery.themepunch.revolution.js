	...
	if (!container.hasClass("revslider-initialised")) {
		...
		container.find('.tp-caption, .rs-background-video-layer').each(function(i) {
			...
			if (_nc.hasClass("tp-caption")) {
				...
				_nc.wrap('<div '+preid+' class="tp-parallax-wrap '+preclas+'" style="position:'+_pos+';'+dmode+';visibility:hidden;"><div class="tp-loop-wrap" style="position:'+_pos+';'+dmode+';"><div class="tp-mask-wrap" style="position:'+_pos+';'+dmode+';" ></div></div></div>');
